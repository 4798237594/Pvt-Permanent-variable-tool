...
[1.0.3] - 2025-11-27 
Add  新增
- Added `var.find()` function to check if a variable file exists
- 新增 `var.find()` 函数用于检查变量文件是否存在 
- Optimized documentation structure and added usage examples for the new function 
- 优化文档结构，新增函数使用示例 
- Updated security check recommendations to use the new `find()` function 
- 更新安全检查建议，推荐使用新的 `find()` 函数
